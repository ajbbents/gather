...
const credentials = {
  ...
  redirect_uris: ["https://ajbbents.github.io/gather/"],
  javascript_origins: ["https://ajbbents.github.io", "http://localhost:8080"],
};
...
module.exports.getAccessToken = async (event) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    //the callback in this case is an arrow function w the results as parameters: "err" and "token"
